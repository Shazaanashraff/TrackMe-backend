# BUSES — TrackMe Backend

Bus records and rider reviews.
...
`src/routes/busRoutes.js`, `src/routes/busReviewRoutes.js`, `src/controllers/busController.js`, `src/controllers/busReviewController.js`, `src/models/Bus.js`, `src/models/BusReview.js`
