...
Socket rooms, connection auth, live-location fan-out, and the membership enforcement that gates PRIVATE routes.
...
`src/socket/socketHandler.js`, `src/models/LiveLocation.js`, and `app.set('io', io)` in `src/server.js`
