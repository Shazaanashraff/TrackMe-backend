# BOOKINGS — TrackMe Backend

Seat bookings. Note the passenger app currently keeps its bookings screens unmounted from navigation.
...
`src/routes/bookingRoutes.js`, `src/controllers/bookingController.js`, `src/models/Booking.js`
