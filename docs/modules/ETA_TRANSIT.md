# ETA & TRANSIT — TrackMe Backend

ETA calculation, transit journey planning, Google Places proxying, and walking paths. The Places key lives here so it never ships in a client.
...
`src/routes/etaRoutes.js`, `src/routes/transitRoutes.js`, `src/routes/placesRoutes.js`, `src/controllers/{eta,transit,places,walk}Controller.js`, `src/utils/geo.js`
